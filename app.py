...
def build_prompt(brief: dict, n: int) -> str:
    lines = [
...
with tab_find:
    ...
    if gen_btn:
        ...
        # Ranking: frei vor ähnlich vor ungeprüft; dann nach Anzahl freier Domains
    ...
    <div class="disclaimer">
      Vor-Filter = EU-Markt-Knockout (EUIPO, Klasse 9/42) + Domain-Verfügbarkeit.
